...
# module references:
# inputCalibration, inputCalibration, NCO, NCO, gain, signalSelector, outputCalibration, outputCalibration
...
# Hierarchical cell: NCO
proc create_hier_cell_NCO { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_NCO() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 13 -to 0 douta

  # Create instance: NCO_sine, and set properties
  set block_name NCO
  set block_cell_name NCO_sine
  if { [catch {set NCO_sine [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $NCO_sine eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: NCO_triangle, and set properties
  set block_name NCO
  set block_cell_name NCO_triangle
  if { [catch {set NCO_triangle [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $NCO_triangle eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: functionSelector, and set properties
  set functionSelector [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 functionSelector ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create instance: signalSelector_0, and set properties
  set block_name signalSelector
  set block_cell_name signalSelector_0
  if { [catch {set signalSelector_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signalSelector_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  set sine [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 sine ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../../LabScripts/redPitaya/auxliary/sine.coe} \
  ...
  # Create instance: triangle, and set properties
  set triangle [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 triangle ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../../LabScripts/redPitaya/auxliary/triangle.coe} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
   CONFIG.Enable_A {Always_Enabled} \
   CONFIG.Load_Init_File {true} \
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins clka] [get_bd_pins NCO_sine/clk_i] [get_bd_pins NCO_triangle/clk_i] [get_bd_pins gain_0/clk_i] [get_bd_pins signalSelector_0/clk_i] [get_bd_pins sine/clka] [get_bd_pins triangle/clka]
  connect_bd_net -net NCO_0_address [get_bd_pins NCO_sine/address] [get_bd_pins sine/addra]
  connect_bd_net -net NCO_triangle_address [get_bd_pins NCO_triangle/address] [get_bd_pins triangle/addra]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins enable/Din] [get_bd_pins freqNCO/Din] [get_bd_pins functionSelector/Din] [get_bd_pins gain/Din]
  connect_bd_net -net enable_Dout [get_bd_pins NCO_sine/enable] [get_bd_pins NCO_triangle/enable] [get_bd_pins enable/Dout]
  connect_bd_net -net freqNCO_Dout [get_bd_pins NCO_sine/freq] [get_bd_pins NCO_triangle/freq] [get_bd_pins freqNCO/Dout]
  connect_bd_net -net functionSelector_Dout [get_bd_pins functionSelector/Dout] [get_bd_pins signalSelector_0/selector]
  connect_bd_net -net gain_0_output_o [get_bd_pins douta] [get_bd_pins gain_0/output_o]
  connect_bd_net -net gain_Dout [get_bd_pins gain/Dout] [get_bd_pins gain_0/gain]
  connect_bd_net -net signalSelector_0_output_o [get_bd_pins gain_0/input_i] [get_bd_pins signalSelector_0/output_o]
  connect_bd_net -net sine_douta [get_bd_pins signalSelector_0/input_0] [get_bd_pins sine/douta]
  connect_bd_net -net triangle_douta [get_bd_pins signalSelector_0/input_1] [get_bd_pins triangle/douta]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: NCO
  create_hier_cell_NCO [current_bd_instance .] NCO
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins DataAcquisition/Din] [get_bd_pins NCO/Din] [get_bd_pins PS7/cfg_data] [get_bd_pins SignalGenerator/Din] [get_bd_pins bias_chB/Din]
