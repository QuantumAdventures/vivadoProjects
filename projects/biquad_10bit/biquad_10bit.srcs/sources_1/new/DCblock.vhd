...
architecture behav of DCblock is

type state_type is (ST0,ST1,ST2,ST3);
signal PS,NS : state_type;

signal gain_a1_sf : sfixed(3 downto -28) := "00010000000000000000000000000000";
signal gain_a2_sf : sfixed(3 downto -28) := "00000000000000000000000000000000";
signal gain_b0_sf : sfixed(3 downto -28) := "00010000000000000000000000000000";
signal gain_b1_sf : sfixed(3 downto -28) := "11110000000000000000000000000000";
signal gain_b2_sf : sfixed(3 downto -28) := "00000000000000000000000000000000";
