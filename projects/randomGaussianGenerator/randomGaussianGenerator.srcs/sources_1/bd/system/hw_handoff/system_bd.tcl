...
# module references:
# brownNoise, gainBrown, gainWhite, ROM_fValues, ROM_gValues, boxMullerAdder, boxMullerMultiplier, boxMullerMultiplier, boxMullerMultiplier, boxMullerMultiplier, signal_split, LF_LFSR_1bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_8bit, addressSelector, LF_LFSR_1bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_8bit, addressSelector, LF_LFSR_1bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_8bit, addressSelector, LF_LFSR_1bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_4bit, LF_LFSR_8bit, addressSelector
...
proc create_hier_cell_SignalGenerator { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net In2_1 [get_bd_pins In2] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins clk_in1] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins clk_wiz_0/clk_in1]
...
proc create_hier_cell_AWGN { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I clk_i
  create_bd_pin -dir O -from 36 -to 0 output_o
  create_bd_pin -dir I -type rst reset
  ...
  connect_bd_net -net boxMullerAdder_0_output_o [get_bd_pins output_o] [get_bd_pins boxMullerAdder_0/output_o]
  ...
  connect_bd_net -net clk_i_1 [get_bd_pins clk_i] [get_bd_pins ROM_fValues_0/clk_i] [get_bd_pins ROM_gValues_0/clk_i] [get_bd_pins addressSelector/clk_i] [get_bd_pins addressSelector_1/clk_i] [get_bd_pins addressSelector_2/clk_i] [get_bd_pins addressSelector_3/clk_i] [get_bd_pins boxMullerAdder_0/clk_i] [get_bd_pins boxMullerMultiplier_0/clk_i] [get_bd_pins boxMullerMultiplier_1/clk_i] [get_bd_pins boxMullerMultiplier_2/clk_i] [get_bd_pins boxMullerMultiplier_3/clk_i]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: brownNoise_0, and set properties
  set block_name brownNoise
  set block_cell_name brownNoise_0
  if { [catch {set brownNoise_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $brownNoise_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: enableBrown, and set properties
  set enableBrown [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 enableBrown ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {64} \
   CONFIG.DIN_TO {64} \
  ...
  # Create instance: gainBrown, and set properties
  set gainBrown [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 gainBrown ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {127} \
   CONFIG.DIN_TO {96} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create instance: gainBrown_0, and set properties
  set block_name gainBrown
  set block_cell_name gainBrown_0
  if { [catch {set gainBrown_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gainBrown_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: gainSpring, and set properties
  set gainSpring [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 gainSpring ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_WIDTH {1024} \
   CONFIG.DOUT_WIDTH {32} \
  ...
  # Create instance: gainStochastic, and set properties
  set gainStochastic [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 gainStochastic ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {63} \
   CONFIG.DIN_TO {32} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PS7_M00_AXI [get_bd_intf_pins PS7/M00_AXI] [get_bd_intf_pins axi_cfg_register_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net AWGN_output_o [get_bd_pins AWGN/output_o] [get_bd_pins brownNoise_0/whiteInput] [get_bd_pins gainWhite_0/whiteInput]
  ...
  connect_bd_net -net PS7_FCLK_CLK0 [get_bd_pins PS7/FCLK_CLK0] [get_bd_pins axi_cfg_register_0/aclk]
  connect_bd_net -net PS7_S00_ARESETN [get_bd_pins PS7/S00_ARESETN] [get_bd_pins axi_cfg_register_0/aresetn]
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins axi_cfg_register_0/cfg_data] [get_bd_pins enableBrown/Din] [get_bd_pins gainBrown/Din] [get_bd_pins gainSpring/Din] [get_bd_pins gainStochastic/Din] [get_bd_pins gainWhite/Din]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins AWGN/clk_i] [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins brownNoise_0/clk_i] [get_bd_pins gainBrown_0/clk_i] [get_bd_pins gainWhite_0/clk_i]
  ...
  connect_bd_net -net brownNoise_0_output_o [get_bd_pins brownNoise_0/output_o] [get_bd_pins gainBrown_0/input_i]
  ...
  connect_bd_net -net enableBrown_Dout [get_bd_pins brownNoise_0/enable] [get_bd_pins enableBrown/Dout]
  connect_bd_net -net gainBrown_0_output_o [get_bd_pins SignalGenerator/Din] [get_bd_pins gainBrown_0/output_o]
  connect_bd_net -net gainBrown_Dout [get_bd_pins gainBrown/Dout] [get_bd_pins gainBrown_0/gain]
  connect_bd_net -net gainSpring_Dout [get_bd_pins brownNoise_0/gainSpring] [get_bd_pins gainSpring/Dout]
  connect_bd_net -net gainStochastic_Dout [get_bd_pins brownNoise_0/gainStochastic] [get_bd_pins gainStochastic/Dout]
  connect_bd_net -net gainWhite_0_output_o [get_bd_pins SignalGenerator/In2] [get_bd_pins gainWhite_0/output_o]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00000800 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs axi_cfg_register_0/s_axi/reg0] -force
