...
proc create_hier_cell_PID { parentCell nameHier } {
  ...
  create_bd_pin -dir I clkEnable
  create_bd_pin -dir I clk_i
  create_bd_pin -dir O -from 13 -to 0 control
  create_bd_pin -dir I -from 13 -to 0 input_i
  create_bd_pin -dir I -from 13 -to 0 set_point_ADC
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net PID_control [get_bd_pins PID/control] [get_bd_pins SignalGenerator/output_CHA]
