...
# module references:
# decimator, inputCalibration, inputCalibration, outputCalibration, outputCalibration
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins decimator_0/clk_i]
  ...
  connect_bd_net -net decimator_0_squareDAC [get_bd_pins SignalGenerator/output_CHA] [get_bd_pins decimator_0/squareDAC]
