...
# module references:
# decimator_DualChannel, inputCalibration, inputCalibration, outputCalibration, outputCalibration, biquadFilter, biquadFilter
...
# Hierarchical cell: biquadFilter1
proc create_hier_cell_biquadFilter1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_biquadFilter1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: biquadFilter0
proc create_hier_cell_biquadFilter0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_biquadFilter0() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create instance: biquadFilter0
  create_hier_cell_biquadFilter0 [current_bd_instance .] biquadFilter0

  # Create instance: biquadFilter1
  create_hier_cell_biquadFilter1 [current_bd_instance .] biquadFilter1
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins biquadFilter0/clk_i] [get_bd_pins biquadFilter1/clk_i] [get_bd_pins decimator_DualChannel_0/clk_i]
  connect_bd_net -net DataAcquisition_output_CHA [get_bd_pins DataAcquisition/output_CHA] [get_bd_pins SignalGenerator/output_CHB] [get_bd_pins decimator_DualChannel_0/input_0]
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins PS7/cfg_data] [get_bd_pins biquadFilter0/Din] [get_bd_pins biquadFilter1/Din]
  ...
  connect_bd_net -net biquadFilter1_output_o [get_bd_pins SignalGenerator/output_CHA] [get_bd_pins biquadFilter1/output_o]
  connect_bd_net -net biquadFilter_output_o [get_bd_pins biquadFilter0/output_o] [get_bd_pins biquadFilter1/input_i]
  ...
  connect_bd_net -net decimator_DualChannel_0_enable [get_bd_pins biquadFilter0/clkEnable] [get_bd_pins biquadFilter1/clkEnable] [get_bd_pins decimator_DualChannel_0/enable]
  connect_bd_net -net decimator_DualChannel_0_output_0 [get_bd_pins biquadFilter0/input_i] [get_bd_pins decimator_DualChannel_0/output_0]
