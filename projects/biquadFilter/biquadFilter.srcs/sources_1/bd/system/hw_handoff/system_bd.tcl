...
# Hierarchical cell: biquadFilter_CHB
proc create_hier_cell_biquadFilter_CHB { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_biquadFilter_CHB() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: biquadGain_CHB, and set properties
  set biquadGain_CHB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 biquadGain_CHB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {671} \
   CONFIG.DIN_TO {640} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create port connections
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins biquadGain_CHB/Din] [get_bd_pins extract_constants/Din]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins clk_i] [get_bd_pins biquadFilter_0/clk_i] [get_bd_pins gain_0/clk_i]
  ...
  connect_bd_net -net biquadGain_CHB_Dout [get_bd_pins biquadGain_CHB/Dout] [get_bd_pins gain_0/gain]
...
# Hierarchical cell: biquadFilter_CHA
proc create_hier_cell_biquadFilter_CHA { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_biquadFilter_CHA() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: biquadGain_CHA, and set properties
  set biquadGain_CHA [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 biquadGain_CHA ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {639} \
   CONFIG.DIN_TO {608} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create port connections
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins biquadGain_CHA/Din] [get_bd_pins extract_constants/Din]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins clk_i] [get_bd_pins biquadFilter_0/clk_i] [get_bd_pins gain_0/clk_i]
  connect_bd_net -net biquadFilter_0_output_o [get_bd_pins biquadFilter_0/output_o] [get_bd_pins gain_0/input_i]
  connect_bd_net -net biquadGain_CHA_Dout [get_bd_pins biquadGain_CHA/Dout] [get_bd_pins gain_0/gain]
  connect_bd_net -net decimator_0_enable [get_bd_pins clkEnable] [get_bd_pins biquadFilter_0/clkEnable]
  connect_bd_net -net decimator_0_output_o [get_bd_pins input_i] [get_bd_pins biquadFilter_0/input_i]
  connect_bd_net -net enable_Dout [get_bd_pins biquadFilter_0/enable] [get_bd_pins extract_constants/Dout3]
  connect_bd_net -net gain_0_output_o [get_bd_pins output_o] [get_bd_pins gain_0/output_o]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: biquadFilter_CHA
  create_hier_cell_biquadFilter_CHA [current_bd_instance .] biquadFilter_CHA

  # Create instance: biquadFilter_CHB
  create_hier_cell_biquadFilter_CHB [current_bd_instance .] biquadFilter_CHB
  ...
  connect_bd_net -net biquadFilter_CHA_output_o [get_bd_pins SignalGenerator/output_CHA] [get_bd_pins biquadFilter_CHA/output_o]
  connect_bd_net -net biquadFilter_CHB_output_o [get_bd_pins SignalGenerator/output_CHB] [get_bd_pins biquadFilter_CHB/output_o]
