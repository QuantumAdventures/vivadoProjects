...
--               c:/Users/tandeitnik/Documents/GitHub/vivadoProjects/projects/biquadFilter/biquadFilter.srcs/sources_1/bd/system/ip/system_gain_0_1/system_gain_0_1_sim_netlist.vhdl
...
entity system_gain_0_1_gain is
  port (
  ...
  attribute ORIG_REF_NAME of system_gain_0_1_gain : entity is "gain";
end system_gain_0_1_gain;

architecture STRUCTURE of system_gain_0_1_gain is
...
\output_o[13]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\output_o[13]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\output_o[13]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7F00FF00FF00FF00"
    )
        port map (
...
\output_o[13]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7F00FF00FF00FF00"
    )
        port map (
...
output_sf_reg: unisim.vcomponents.DSP48E1
    generic map(
      ...
      P(12) => p_0_out_0(13),
      P(11 downto 0) => p_0_out(12 downto 1),
...
entity system_gain_0_1 is
  ...
  attribute NotValidForBitStream of system_gain_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_gain_0_1 : entity is "system_gain_0_1,gain,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_gain_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_gain_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_gain_0_1 : entity is "gain,Vivado 2020.1";
end system_gain_0_1;

architecture STRUCTURE of system_gain_0_1 is
begin
inst: entity work.system_gain_0_1_gain
     port map (
      clk_i => clk_i,
