...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_4 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../PID.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
