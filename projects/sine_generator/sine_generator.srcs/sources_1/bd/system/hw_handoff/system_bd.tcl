...
# module references:
# inputCalibration, inputCalibration, NCO, gain, outputCalibration, outputCalibration
...
proc create_hier_cell_NCO { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../../../../Desktop/sine.coe} \
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins clka] [get_bd_pins NCO_0/clk_i] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins gain_0/clk_i]
  connect_bd_net -net NCO_0_address [get_bd_pins NCO_0/address] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins enable/Din] [get_bd_pins freqNCO/Din] [get_bd_pins gain/Din]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins gain_0/input_i]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins DataAcquisition/Din] [get_bd_pins NCO/Din] [get_bd_pins PS7/cfg_data] [get_bd_pins SignalGenerator/Din]
