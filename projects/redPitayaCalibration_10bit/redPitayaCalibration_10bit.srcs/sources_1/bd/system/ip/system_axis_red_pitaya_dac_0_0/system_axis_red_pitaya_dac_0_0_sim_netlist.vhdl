...
-- Date        : Tue May 28 15:57:22 2024
-- Host        : DESKTOP-40PU04J running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/tandeitnik/Documents/GitHub/vivadoProjects/projects/redPitayaCalibration_10bit/redPitayaCalibration_10bit.srcs/sources_1/bd/system/ip/system_axis_red_pitaya_dac_0_0/system_axis_red_pitaya_dac_0_0_sim_netlist.vhdl
...
entity system_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac is
  port (
    ...
    dac_dat : out STD_LOGIC_VECTOR ( 9 downto 0 );
    aclk : in STD_LOGIC;
...
architecture STRUCTURE of system_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac is
  signal int_dat_a_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal int_dat_b_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
...
architecture STRUCTURE of system_axis_red_pitaya_dac_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of ddr_clk : signal is "XIL_INTERFACENAME ddr_clk, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /SignalGenerator/clk_wiz_0_clk_out1, INSERT_VIP 0";
...
inst: entity work.system_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac
     port map (
      aclk => aclk,
      dac_clk => dac_clk,
      dac_dat(9 downto 0) => dac_dat(9 downto 0),
      dac_rst => dac_rst,
      dac_sel => dac_sel,
      dac_wrt => dac_wrt,
      ddr_clk => ddr_clk,
