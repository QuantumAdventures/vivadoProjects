...
# module references:
# mux2, mux2, inputCalibration, inputCalibration, outputCalibration, outputCalibration
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "Red Pitaya Calibration" [get_bd_designs $design_name]
...
proc create_hier_cell_calibConstants { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_calibConstants() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net outIntCorrCHA_Dout [get_bd_pins Dout1] [get_bd_pins outIntCorrCHA/Dout]
  connect_bd_net -net outIntCorrCHB_Dout [get_bd_pins Dout2] [get_bd_pins outIntCorrCHB/Dout]
  connect_bd_net -net outSlpCorrCHA_Dout [get_bd_pins Dout] [get_bd_pins outSlpCorrCHA/Dout]
  connect_bd_net -net outSlpCorrCHB_Dout [get_bd_pins Dout3] [get_bd_pins outSlpCorrCHB/Dout]
...
proc create_hier_cell_calibrationConstants { parentCell nameHier } {
  ...
  connect_bd_net -net intCorrCHA_Dout [get_bd_pins Dout] [get_bd_pins inIntCorrCHA/Dout]
...
proc create_hier_cell_SignalGenerator { parentCell nameHier } {
  ...
  # Create instance: calibConstants
  create_hier_cell_calibConstants $hier_obj calibConstants
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins calibConstants/Din]
  ...
  connect_bd_net -net outIntCorrCHA_Dout [get_bd_pins calibConstants/Dout1] [get_bd_pins outputCalibration_A/intercept_correction]
  connect_bd_net -net outIntCorrCHB_Dout [get_bd_pins calibConstants/Dout2] [get_bd_pins outputCalibration_b/intercept_correction]
  connect_bd_net -net outSlpCorrCHA_Dout [get_bd_pins calibConstants/Dout] [get_bd_pins outputCalibration_A/slope_correction]
  connect_bd_net -net outSlpCorrCHB_Dout [get_bd_pins calibConstants/Dout3] [get_bd_pins outputCalibration_b/slope_correction]
...
proc create_hier_cell_DataAcquisition { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 9 -to 0 output_CHA
  create_bd_pin -dir O -from 9 -to 0 output_CHB
  ...
  connect_bd_net -net inIntCorrCHB_Dout [get_bd_pins calibrationConstants/Dout1] [get_bd_pins inputCalibration_B/intercept_correction]
  connect_bd_net -net inSlpCorrCHA_Dout [get_bd_pins calibrationConstants/Dout2] [get_bd_pins inputCalibration_A/slope_correction]
  connect_bd_net -net inSlpCorrCHB_Dout [get_bd_pins calibrationConstants/Dout3] [get_bd_pins inputCalibration_B/slope_correction]
  ...
  connect_bd_net -net intCorrCHA_Dout [get_bd_pins calibrationConstants/Dout] [get_bd_pins inputCalibration_A/intercept_correction]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: calibrationSignal_CHA, and set properties
  set calibrationSignal_CHA [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 calibrationSignal_CHA ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {297} \
   CONFIG.DIN_TO {288} \
   CONFIG.DIN_WIDTH {1024} \
   CONFIG.DOUT_WIDTH {10} \
 ] $calibrationSignal_CHA

  # Create instance: calibrationSignal_CHB, and set properties
  set calibrationSignal_CHB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 calibrationSignal_CHB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {329} \
   CONFIG.DIN_TO {320} \
   CONFIG.DIN_WIDTH {1024} \
   CONFIG.DOUT_WIDTH {10} \
 ] $calibrationSignal_CHB

  # Create instance: mux2_CHA, and set properties
  set block_name mux2
  set block_cell_name mux2_CHA
  if { [catch {set mux2_CHA [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux2_CHA eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: mux2_CHB, and set properties
  set block_name mux2
  set block_cell_name mux2_CHB
  if { [catch {set mux2_CHB [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux2_CHB eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: sel_CHA, and set properties
  set sel_CHA [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sel_CHA ]
  set_property -dict [ list \
   CONFIG.DIN_WIDTH {1024} \
 ] $sel_CHA

  # Create instance: sel_CHB, and set properties
  set sel_CHB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sel_CHB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins mux2_CHA/clk_i] [get_bd_pins mux2_CHB/clk_i]
  connect_bd_net -net DataAcquisition_output_CHA [get_bd_pins DataAcquisition/output_CHA] [get_bd_pins mux2_CHA/in1]
  connect_bd_net -net DataAcquisition_output_CHB [get_bd_pins DataAcquisition/output_CHB] [get_bd_pins mux2_CHB/in1]
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins DataAcquisition/Din] [get_bd_pins PS7/cfg_data] [get_bd_pins SignalGenerator/Din] [get_bd_pins calibrationSignal_CHA/Din] [get_bd_pins calibrationSignal_CHB/Din] [get_bd_pins sel_CHA/Din] [get_bd_pins sel_CHB/Din]
  ...
  connect_bd_net -net calibrationSignal_CHA_Dout [get_bd_pins calibrationSignal_CHA/Dout] [get_bd_pins mux2_CHA/in0]
  connect_bd_net -net calibrationSignal_CHB_Dout [get_bd_pins calibrationSignal_CHB/Dout] [get_bd_pins mux2_CHB/in0]
  ...
  connect_bd_net -net mux2_CHA_output_o [get_bd_pins SignalGenerator/output_CHA] [get_bd_pins mux2_CHA/output_o]
  connect_bd_net -net mux2_CHB_output_o [get_bd_pins SignalGenerator/output_CHB] [get_bd_pins mux2_CHB/output_o]
  connect_bd_net -net s_axis_tvalid_1 [get_bd_pins DataAcquisition/m_axis_tvalid] [get_bd_pins SignalGenerator/s_axis_tvalid]
  connect_bd_net -net sel_CHA_Dout [get_bd_pins mux2_CHA/sel] [get_bd_pins sel_CHA/Dout]
  connect_bd_net -net sel_CHB_Dout [get_bd_pins mux2_CHB/sel] [get_bd_pins sel_CHB/Dout]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mux2_CHA/clkEnable] [get_bd_pins mux2_CHB/clkEnable] [get_bd_pins xlconstant_0/dout]
