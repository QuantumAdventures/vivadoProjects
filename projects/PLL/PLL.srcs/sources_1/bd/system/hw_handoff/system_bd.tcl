...
# module references:
# inputCalibration, inputCalibration, phaseDetector, outputCalibration, outputCalibration, biquadFilter, decimator, comparator, NCO
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "PLL" [get_bd_designs $design_name]
...
proc create_hier_cell_calibrationConstants_1 { parentCell nameHier } {
  ...
  connect_bd_net -net outIntCorrCHA_Dout [get_bd_pins Dout2] [get_bd_pins outIntCorrCHA/Dout]
  connect_bd_net -net outIntCorrCHB_Dout [get_bd_pins Dout3] [get_bd_pins outIntCorrCHB/Dout]
...
# Hierarchical cell: numericallyControledOscillator
proc create_hier_cell_numericallyControledOscillator { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_numericallyControledOscillator() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 1 -to 0 error
  create_bd_pin -dir O -from 13 -to 0 sine_output
  create_bd_pin -dir O square_output
  ...
  # Create instance: freqCorrection, and set properties
  set freqCorrection [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 freqCorrection ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {383} \
   CONFIG.DIN_TO {352} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create instance: freqNCO, and set properties
  set freqNCO [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 freqNCO ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {287} \
   CONFIG.DIN_TO {256} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create instance: phaseCorrection, and set properties
  set phaseCorrection [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 phaseCorrection ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {351} \
   CONFIG.DIN_TO {320} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins clk_i] [get_bd_pins NCO_0/clk_i]
  connect_bd_net -net NCO_0_sine_output [get_bd_pins sine_output] [get_bd_pins NCO_0/sine_output]
  connect_bd_net -net NCO_0_square_output [get_bd_pins square_output] [get_bd_pins NCO_0/square_output]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins delay/Din] [get_bd_pins enable/Din] [get_bd_pins freqCorrection/Din] [get_bd_pins freqNCO/Din] [get_bd_pins phaseCorrection/Din]
  connect_bd_net -net delay_Dout [get_bd_pins NCO_0/delay] [get_bd_pins delay/Dout]
  connect_bd_net -net enable_Dout [get_bd_pins NCO_0/enable] [get_bd_pins enable/Dout]
  connect_bd_net -net error_1 [get_bd_pins error] [get_bd_pins NCO_0/error]
  connect_bd_net -net freqCorrection_Dout [get_bd_pins NCO_0/freqCorrection] [get_bd_pins freqCorrection/Dout]
  connect_bd_net -net freqNCO_Dout [get_bd_pins NCO_0/freq] [get_bd_pins freqNCO/Dout]
  connect_bd_net -net phaseCorrection_Dout [get_bd_pins NCO_0/phaseCorrection] [get_bd_pins phaseCorrection/Dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: comparator
proc create_hier_cell_comparator { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_comparator() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: negative_offset, and set properties
  set negative_offset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 negative_offset ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {205} \
   CONFIG.DIN_TO {192} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create instance: positive_offset, and set properties
  set positive_offset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 positive_offset ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {237} \
   CONFIG.DIN_TO {224} \
   CONFIG.DIN_WIDTH {1024} \
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins clk_i] [get_bd_pins comparator_0/clk_i]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins negative_offset/Din] [get_bd_pins positive_offset/Din]
  connect_bd_net -net biquadFilter_output_o [get_bd_pins input_i] [get_bd_pins comparator_0/input_i]
  connect_bd_net -net comparator_0_output_o [get_bd_pins output_o] [get_bd_pins comparator_0/output_o]
  connect_bd_net -net negative_offset_Dout [get_bd_pins comparator_0/negative_offset] [get_bd_pins negative_offset/Dout]
  connect_bd_net -net positive_offset_Dout [get_bd_pins comparator_0/positive_offset] [get_bd_pins positive_offset/Dout]
...
proc create_hier_cell_calibrationConstants { parentCell nameHier } {
  ...
  connect_bd_net -net inIntCorrCHA_Dout [get_bd_pins Dout3] [get_bd_pins inIntCorrCHA/Dout]
  connect_bd_net -net inIntCorrCHB_Dout [get_bd_pins Dout] [get_bd_pins inIntCorrCHB/Dout]
  connect_bd_net -net inSlpCorrCHA_Dout [get_bd_pins Dout2] [get_bd_pins inSlpCorrCHA/Dout]
  connect_bd_net -net inSlpCorrCHB_Dout [get_bd_pins Dout1] [get_bd_pins inSlpCorrCHB/Dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: requiredStuff
proc create_hier_cell_requiredStuff { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_requiredStuff() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_SignalGenerator { parentCell nameHier } {
  ...
  connect_bd_net -net calibrationConstants_Dout2 [get_bd_pins calibrationConstants/Dout2] [get_bd_pins outputCalibration_A/intercept_correction]
  connect_bd_net -net calibrationConstants_Dout3 [get_bd_pins calibrationConstants/Dout3] [get_bd_pins outputCalibration_b/intercept_correction]
...
proc create_hier_cell_PLL { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PLL() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: comparator
  create_hier_cell_comparator $hier_obj comparator

  # Create instance: numericallyControledOscillator
  create_hier_cell_numericallyControledOscillator $hier_obj numericallyControledOscillator

  # Create instance: phaseDetector_0, and set properties
  set block_name phaseDetector
  set block_cell_name phaseDetector_0
  if { [catch {set phaseDetector_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $phaseDetector_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins clk_i] [get_bd_pins comparator/clk_i] [get_bd_pins numericallyControledOscillator/clk_i] [get_bd_pins phaseDetector_0/clk_i]
  connect_bd_net -net NCO_0_sine_output [get_bd_pins sine_output] [get_bd_pins numericallyControledOscillator/sine_output]
  connect_bd_net -net NCO_0_square_output [get_bd_pins numericallyControledOscillator/square_output] [get_bd_pins phaseDetector_0/clk_reg]
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins Din] [get_bd_pins comparator/Din] [get_bd_pins numericallyControledOscillator/Din]
  connect_bd_net -net biquadFilter_output_o [get_bd_pins input_i] [get_bd_pins comparator/input_i]
  connect_bd_net -net comparator_0_output_o [get_bd_pins comparator/output_o] [get_bd_pins phaseDetector_0/clk_ref]
  connect_bd_net -net phaseDetector_0_phaseError [get_bd_pins numericallyControledOscillator/error] [get_bd_pins phaseDetector_0/phaseError]
...
proc create_hier_cell_DataAcquisition { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 13 -to 0 output_CHA
  create_bd_pin -dir O -from 13 -to 0 output_CHB
  ...
  connect_bd_net -net calibrationConstants_Dout [get_bd_pins calibrationConstants/Dout] [get_bd_pins inputCalibration_B/intercept_correction]
  connect_bd_net -net calibrationConstants_Dout1 [get_bd_pins calibrationConstants/Dout1] [get_bd_pins inputCalibration_B/slope_correction]
  ...
  connect_bd_net -net calibrationConstants_Dout3 [get_bd_pins calibrationConstants/Dout3] [get_bd_pins inputCalibration_A/intercept_correction]
  ...
  connect_bd_net -net inputCalibration_B_output_o [get_bd_pins output_CHB] [get_bd_pins inputCalibration_B/output_o]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: requiredStuff
  create_hier_cell_requiredStuff [current_bd_instance .] requiredStuff
  ...
  # Create port connections
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins PLL/clk_i] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins biquadFilter/clk_i]
  connect_bd_net -net DataAcquisition_output_CHA [get_bd_pins DataAcquisition/output_CHA] [get_bd_pins biquadFilter/input_i]
  connect_bd_net -net PLL_sine_output [get_bd_pins PLL/sine_output] [get_bd_pins SignalGenerator/output_CHA]
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins DataAcquisition/Din] [get_bd_pins PLL/Din] [get_bd_pins PS7/cfg_data] [get_bd_pins SignalGenerator/Din] [get_bd_pins biquadFilter/Din]
  ...
  connect_bd_net -net biquadFilter_output_o [get_bd_pins PLL/input_i] [get_bd_pins SignalGenerator/output_CHB] [get_bd_pins biquadFilter/output_o]
  connect_bd_net -net daisy_n_i_1 [get_bd_ports daisy_n_i] [get_bd_pins requiredStuff/daisy_n_i]
  connect_bd_net -net daisy_p_i_1 [get_bd_ports daisy_p_i] [get_bd_pins requiredStuff/daisy_p_i]
  connect_bd_net -net s_axis_tvalid_1 [get_bd_pins DataAcquisition/m_axis_tvalid] [get_bd_pins SignalGenerator/s_axis_tvalid]
  connect_bd_net -net util_ds_buf_2_OBUF_DS_N [get_bd_ports daisy_n_o] [get_bd_pins requiredStuff/daisy_n_o]
  connect_bd_net -net util_ds_buf_2_OBUF_DS_P [get_bd_ports daisy_p_o] [get_bd_pins requiredStuff/daisy_p_o]
