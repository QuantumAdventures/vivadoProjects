...
HD_PWD='G:/Meu Drive/redpitaya_guide-master/projects/PLL/PLL.runs/system_signalSelector_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_signalSelector_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_signalSelector_0_1.tcl
