...
proc create_hier_cell_calibrationConstants { parentCell nameHier } {
  ...
  connect_bd_net -net outSlpCorrCHA_Dout [get_bd_pins Dout3] [get_bd_pins outSlpCorrCHA/Dout]
...
proc create_hier_cell_SignalGenerator { parentCell nameHier } {
  ...
  connect_bd_net -net Din_2 [get_bd_pins Din] [get_bd_pins calibrationConstants/Din]
  ...
  connect_bd_net -net calibrationConstants_Dout1 [get_bd_pins calibrationConstants/Dout1] [get_bd_pins outputCalibration_A/intercept_correction]
  ...
  connect_bd_net -net calibrationConstants_Dout3 [get_bd_pins calibrationConstants/Dout3] [get_bd_pins outputCalibration_A/slope_correction]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_cfg_register_0_cfg_data [get_bd_pins AWGN/gain] [get_bd_pins PS7/cfg_data] [get_bd_pins SignalGenerator/Din] [get_bd_pins biquadFilter/constants]
