...
# module references:
# clkDivider, rndGaussGen2, signal_split
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rndGaussGen2_0, and set properties
  set block_name rndGaussGen2
  set block_cell_name rndGaussGen2_0
  if { [catch {set rndGaussGen2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rndGaussGen2_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net DataAcquisition_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins SignalGenerator/clk_in1] [get_bd_pins clkDivider_0/clk_i] [get_bd_pins rndGaussGen2_0/clk_i]
  ...
  connect_bd_net -net clkDivider_0_clk_o [get_bd_pins clkDivider_0/clk_o] [get_bd_pins rndGaussGen2_0/enable]
  ...
  connect_bd_net -net rndGaussGen2_0_rndNumb [get_bd_pins SignalGenerator/Din] [get_bd_pins rndGaussGen2_0/rndNumb]
